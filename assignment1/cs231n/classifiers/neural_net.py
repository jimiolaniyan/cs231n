...
class TwoLayerNet(object):
  ...
  """
    ...
    """
        ...
        cc_scores = scores[np.arange(0, N), y]
        ...
        p_sc = p[np.arange(0, N), y] - 1
        p[np.arange(0, N), y] = 0

        int_zer = np.zeros(p.shape)
        int_zer[np.arange(0, N), y] = p_sc
    ...
    """
        ...
        ###########################################################################
        h1 = X.dot(self.params['W1'])
        relu = lambda x: np.maximum(0, x)
        h1_relu = relu(h1)
        scores = h1_relu.dot(self.params['W2'])
